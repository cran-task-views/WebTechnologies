...
-   [osi](http://cran.rstudio.com/web/packages/osi/index.html) ([GitHub](https://github.com/Ironholds/osi/)) retrieves open source license data and metadata from [https://api.opensource.org/licenses/](https://api.opensource.org/licenses/).
...
-   [shopifyr](http://cran.rstudio.com/web/packages/shopifyr/index.html): An interface to the API of the E-commerce service Shopify [https://help.shopify.com/api](https://help.shopify.com/api).
