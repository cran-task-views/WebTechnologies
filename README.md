...
**Other Web Services**
  ...
  - [cymruservices](https://cran.rstudio.com/web/packages/cymruservices/index.html) queries [Team Cymru](https://www.team-cymru.com/) web security services.
  ...
  - [livechatR](https://cran.rstudio.com/web/packages/livechatR/index.html) is a client for the [LiveChat API](https://developers.livechatinc.com/docs/management/configuration-api/v2.0/) .
  ...
  - [<span class="GitHub">ripplerestr</span>](https://github.com/hmalmedal/ripplerestr/) provides an interface to the [Ripple](https://www.ripple.com/) protocol for making financial transactions.
  ...
  - [rwars](https://cran.rstudio.com/web/packages/rwars/index.html) retrieve and reformat data from the Star Wars API (SWAPI).
