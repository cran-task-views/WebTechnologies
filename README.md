...
-   *RSS/Atom*: [feedeR](https://github.com/DataWookie/feedeR) (not on CRAN) can be used to parse RSS or Atom feeds.
...
-   [rgeospatialquality](http://cran.rstudio.com/web/packages/rgeospatialquality/index.html)
