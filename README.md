...
**Other Web Services**
  ...
  - [livechatR](https://cran.rstudio.com/web/packages/livechatR/index.html) is a client for the [LiveChat API](https://developers.livechatinc.com/docs/management/configuration-api-v2/) .
